...
public class seven {
	...
	*/
	private static void operatorMenu(Connection connection) {
		// TODO Auto-generated method stub
	...
	public static void adminMenu(Connection connection) throws FileNotFoundException, DocumentException{
		String query="";
		while(true){
